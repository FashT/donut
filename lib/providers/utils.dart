...
class DonutBottomBarSelectionService extends ChangeNotifier {
  ...
  //   Utils.mainAppNav.currentState!.pushReplacementNamed('/$selection');
...
class DonutPage {
  ...
  DonutPage({required this.imgLogoUrl, required this.imgUrl});
}
...
void filteredDonutsByType(type){
...
class DonutModel {
  ...
  DonutModel({required this.description, required this.imgUrl, required this.name, required this.price, required this.type });
}
